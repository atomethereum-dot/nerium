...
// ojo lee donde esta la tinta, no donde acaba la caja. Baja 0,2134 em, que
...
di(marca && Math.abs(marca.desfase - 0.2134) < 0.03,
   'y baja del medio del rombo lo que tiene que bajar (' +
   (marca ? marca.desfase.toFixed(4) : '?') + ' em, buscado 0,2134; el dibujo va del ' +
